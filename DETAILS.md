...
Tests: `python tests.py` → **47 passing** (stdlib `unittest`, one `test_stage{1,2,3,4}.py` per stage;
...
tests.py + test_stage{1,2,3,4}.py # stdlib-unittest runner + per-stage tests
